...
public interface XMPPConnection {
    ...
    */
     ...
     * with a {@link NoResponseException}. The callback will be invoked at most once.
     * </p>
     *
     * @param stanza the stanza to send (required)
     * @param replyFilter the filter used to determine response stanza (required)
     ...
     * {@link IQ.Type#result} with that result IQ. The callback will
    ...
    /**
     * Send a IQ stanza and invoke <code>callback</code> if there is a result of
     * {@link IQ.Type#result} with that result IQ. If there is an
     * error response <code>exceptionCallback</code> will be invoked, if not null, with the received
     * error as {@link XMPPErrorException}. If there is no response after the
     ...
     * {@link IQ.Type#result} with that result IQ. If there is an
     * error response <code>exceptionCallback</code> will be invoked, if not null, with the received
     * error as {@link XMPPErrorException}. If there is no response after
    ...
    /**
     * Convenience method for {@link #unregisterIQRequestHandler(String, String, IQ.Type)}.
     *
