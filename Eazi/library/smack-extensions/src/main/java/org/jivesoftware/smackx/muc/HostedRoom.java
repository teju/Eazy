 ...
 * {@link MultiUserChatManager#getRoomInfo(EntityBareJid)}
 * or could be used for joining the room
 * {@link MultiUserChatManager#getMultiUserChat(EntityBareJid)}
 * and {@link MultiUserChat#join(org.jxmpp.jid.parts.Resourcepart)}.
 *
