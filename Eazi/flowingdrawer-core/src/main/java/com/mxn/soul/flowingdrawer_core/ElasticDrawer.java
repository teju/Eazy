...
public abstract class ElasticDrawer extends ViewGroup {
    ...
    protected void initDrawer(Context context, AttributeSet attrs, int defStyle) {
        ...
        mMenuSize = a.getDimensionPixelSize(R.styleable.ElasticDrawer_edMenuSize, dpToPx(100));
...
//            valueAnimator.start();
            ...
            System.out.println("Exception1234 smoothClose "+e.toString());
        }
    }
